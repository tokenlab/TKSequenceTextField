...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of TKSequenceTextField.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/Edudjr/TKSequenceTextField'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Edudjr' => 'eduardo.djr@hotmail.com' }
  s.source           = { :git => 'https://github.com/Edudjr/TKSequenceTextField.git', :tag => s.version.to_s }
